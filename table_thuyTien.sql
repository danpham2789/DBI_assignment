...
-- Update book when someone borrow
...
-- test trigger
select * from book_copies where copy_id = 'C003';

insert into loans (loan_id, copy_id, member_id, staff_id, loan_date, due_date, return_date, status) 
values ('L004', 'C003', 'M004', 'S001', '2025-03-19', '2025-04-02', NULL, 'borrowed');
...
-- test procedure
exec add_new_book 'B030', N'Grand Escape', 'A001', '978-1234566534', 2025;


-- Book have been lost
create view lost_books as
...
create function check_book_availability (@book_id varchar(50))
return bit
as
begin
...
-- test function
select dbo.check_book_availability('B001') as Available;
